...
const (
	...
	// V1IndexerChainedTxTypeINDEXERCHAINEDTXTYPEARK captures enum value "INDEXER_CHAINED_TX_TYPE_ARK"
	V1IndexerChainedTxTypeINDEXERCHAINEDTXTYPEARK V1IndexerChainedTxType = "INDEXER_CHAINED_TX_TYPE_ARK"

	// V1IndexerChainedTxTypeINDEXERCHAINEDTXTYPETREE captures enum value "INDEXER_CHAINED_TX_TYPE_TREE"
	V1IndexerChainedTxTypeINDEXERCHAINEDTXTYPETREE V1IndexerChainedTxType = "INDEXER_CHAINED_TX_TYPE_TREE"

	// V1IndexerChainedTxTypeINDEXERCHAINEDTXTYPECHECKPOINT captures enum value "INDEXER_CHAINED_TX_TYPE_CHECKPOINT"
	V1IndexerChainedTxTypeINDEXERCHAINEDTXTYPECHECKPOINT V1IndexerChainedTxType = "INDEXER_CHAINED_TX_TYPE_CHECKPOINT"
)
...
func init() {
	...
	if err := json.Unmarshal([]byte(`["INDEXER_CHAINED_TX_TYPE_UNSPECIFIED","INDEXER_CHAINED_TX_TYPE_COMMITMENT","INDEXER_CHAINED_TX_TYPE_ARK","INDEXER_CHAINED_TX_TYPE_TREE","INDEXER_CHAINED_TX_TYPE_CHECKPOINT"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
